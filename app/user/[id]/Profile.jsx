...
export default function Profile({ user, profileId }) {
  ...
  return (
    <div
      ...
      className="w-4/5 h-full flex flex-col sm:flex-row content-center justify-center gap-12"
    >
      <div className="w-full sm:w-64">
        <Card id="profile-info" className="max-w-[340px] px-2 py-1">
          <CardHeader>
            <div className="w-full flex justify-between items-center">
              ...
              {user?.id === profileId ? (
                ...
                <FollowButton user={user} profileId={profileId} />
              )}
            </div>
          </CardHeader>
          <CardBody className="px-3 pt-0 text-small text-default-400">
            <div id="follow-modals" className="flex flex-row gap-3 pb-2">
              <div id="following">
                <Link href="#" size="sm" onPress={onFollowingOpen}>
              ...
              <div id="followers">
                <Link href="#" size="sm" onPress={onFollowersOpen}>
            ...
            <p className="min-w-full text-xs text-slate-400 text-center">
              Joined {parseAndHumanizeDate(profile?.created_at)}
            </p>
          </CardBody>
        </Card>
        <ActivtyGraph profileId={profileId} />
      </div>
      <SavesViewer user={user} profileId={profileId} />
    </div>
  );
}
